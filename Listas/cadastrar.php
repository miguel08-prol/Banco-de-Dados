...
if (!isset($_POST['nome_cliente'], $_POST['cpf'], $_POST['email'])) {
    ...
    $sql = "INSERT INTO Cliente (nome_cliente, CPF, email) VALUES ('$nome', '$cpf', '$email')";
    ...
    if ($conn->query($sql) === TRUE) {
        echo "<div class='message-box success'>
                ...
                <br>
                <a href='lista.php' class='btn'>Ver Lista</a>
                <a href='index.html' class='btn'>Cadastrar Outro</a>
              </div>";
    } else {
        echo "<div class='message-box error'>

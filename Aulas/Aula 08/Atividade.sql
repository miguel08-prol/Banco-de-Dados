...
-- AS:dá apelido a tabelas exibidas
...
from Cliente inner join Venda
on Cliente.CodCli = Venda.CodCli
where year(Venda.Vencto ) = 2006 and month(Venda.Vencto) = 10
...
-- Atividade 5
select Cliente.nome, COUNT(Venda.Duplic) as quantidade_titulos,SUM(Venda.Valor) as soma_duplicatas
from Cliente inner join Venda 
on Cliente.CodCli = Venda.CodCli
group by Cliente.nome;

-- Atividade 6
select Cliente.nome, COUNT(Venda.Duplic) as VENCIDOS
from Cliente inner join Venda 
on Cliente.CodCli = Venda.CodCli
...
-- Atividade 7
select Cliente.nome,Venda.Valor as valor_Duplicado,round(Venda.Valor * 0.10,2) AS Juros,round(Venda.Valor * 1.10,2) as Cobrança
from Cliente inner join Venda
on Cliente.CodCli = Venda.CodCli
